#!/bin/sh
# STW-Pacote v0.5 - Atualizacao (rode dentro do shell "sh")
RAW="https://raw.githubusercontent.com/bariquello/STW-Pacote/main"
TMP="/tmp/stw_upd"
echo "===== STW-Pacote :: Atualizacao 0.5 ====="
...
php -q -r 'require_once("config.inc");require_once("functions.inc");require_once("pkg-utils.inc");require_once("/usr/local/pkg/stw_pacote.inc");stw_deploy_theme();stw_aplicar_tema();stw_registrar_menu();stw_pacote_resync();echo "atualizado\n";'
