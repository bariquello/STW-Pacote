...
$(function() {
	...
	$('#headerrow').html('<div id="logodiv" style="text-align:center" class="nowarning"><img src="/logo-branco.jpg" width="300" style="margin-right: 20px"></div>');
	$('title').text('SystemWay');
